...
export type ContextMcpConfigItem = { readonly source: string };
export type ContextMcpServerItem = {
	readonly name: string;
	readonly source: string;
