...
export function mountAnnotator(
	...
	// Escape closes an open comment first (handled by the textarea) and
	// leaves annotate mode otherwise. The dashboard mirrors this for when
	// focus is outside the preview.
